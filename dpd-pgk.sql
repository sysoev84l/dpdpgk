...
--
-- Хост: localhost
-- Время создания: Дек 17 2023 г., 20:26
...
--
-- Дамп данных таблицы `work_price`
--

INSERT INTO `work_price` (`id`, `since_date`, `price`) VALUES
(2, '2022-09-01', 150),
(5, '2021-02-01', 135),
(6, '2023-10-01', 209);
...
INSERT INTO `work_time` (`id`, `date`, `time_start`, `time_end`, `break_time`) VALUES
...
(329, '2023-11-16', '09:00:00', '20:00:00', 1),
...
--
-- AUTO_INCREMENT для таблицы `work_price`
--
ALTER TABLE `work_price`
